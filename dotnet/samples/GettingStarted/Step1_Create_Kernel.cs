...
public sealed class Step1_Create_Kernel(ITestOutputHelper output) : BaseTest(output)
{
    ...
    public async Task RunAsync()
    {
        ...
        arguments = new(new AzureOpenAIPromptExecutionSettings { MaxTokens = 500, Temperature = 0.5 }) { { "topic", "dogs" } };
...
#pragma warning disable SKEXP0010
        arguments = new(new AzureOpenAIPromptExecutionSettings { ResponseFormat = "json_object" }) { { "topic", "chocolate" } };
